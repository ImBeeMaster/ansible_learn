Vagrant.configure("2") do |config|
  ...
  config.vm.define "slave-1" do |vb1|
    ...
    vb1.vm.network :private_network, ip: "192.168.1.3"
...
config.vm.define "slave-2" do |vb2|
  ...
  vb2.vm.network :private_network, ip: "192.168.1.4"
...
config.vm.define "slave-3" do |vb2|
  ...
  vb2.vm.network :private_network, ip: "192.168.1.5"
...
config.vm.define "slave-4" do |vb2|
  ...
  vb2.vm.network :private_network, ip: "192.168.1.6"
...
config.vm.define "slave-5" do |vb2|
  ...
  vb2.vm.network :private_network, ip: "192.168.1.7"
